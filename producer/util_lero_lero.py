...
def valor_aleatorio_lista(lista):
    import random
    if(lista == []):
        return None
...
def gerar_lero_lero():
    return f'{valor_aleatorio_lista(lista0)}{valor_aleatorio_lista(lista1)}{valor_aleatorio_lista(lista2)}{valor_aleatorio_lista(lista3)}'